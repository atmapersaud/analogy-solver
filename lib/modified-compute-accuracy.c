...
int main(int argc, char **argv)
{
  ...
  volatile long long a; // a used to be declared on the previous line with the rest of the variables as long long
  float *M;
  char *vocab;
  ...
  while (1) {
    ...
    //find indexes of the query words in the vocab
